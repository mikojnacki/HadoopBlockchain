 ...
 */
public class AddressOutputRawDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(getConf(), "AddressOutputRaw program");
        ...
        job.setMapperClass(AddressOutputRawMapper.class);
