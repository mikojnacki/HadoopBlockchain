 ...
 */
public class AddressOutputDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(getConf(), "AddressOutput program");
        ...
        job.setMapperClass(AddressOutputMapper.class);
        job.setReducerClass(AddressOutputReducer.class);
